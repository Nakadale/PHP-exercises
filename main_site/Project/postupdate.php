...
<div id="container">
	...
	<br />
		...
		$query = mysql_query("UPDATE bulletin SET post_title ='".$post_title."', post_time ='".$time."', post_date ='".$date."', post_content ='".$post_content."' WHERE post_id = '".$post_id."'",$link );
		If ($query == TRUE) {
		echo '<p><div align="top" style="width:570px;">Post Updated<br>';
		...
		$result = @mysql_query("SELECT * FROM bulletin",$link );
