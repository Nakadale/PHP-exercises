...
<div id="container">
	...
	<!--end of navigation area of webpage-->
		...
		echo '<fieldset><legend><font style="color:white;">Dive Event Information </font></legend>';
		...
		echo '</table><p>';
		echo '<form action="divemod.php" method="POST" >';
		echo '<input type="hidden" name="dive_number" value='.$divenum.'>';
		echo '<div align="center"><input type="submit" name="submit" value="Modify Dive Event Information" /></div><p>';
		echo '</fieldset></form>';
		?>
	</td>
