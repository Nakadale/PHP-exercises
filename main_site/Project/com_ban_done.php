...
<div id="container">
	...
	<br />
		...
		$query = mysql_query("UPDATE comments SET com_comment ='Comment Banned.' WHERE comment_number = '".$com_id."'",$link );
		If ($query == TRUE) {
		echo '<p><div align="top" style="width:570px;">Comment Banned<br>';
		echo '<form action="post_index.php"><input type="submit" value="Back to Index"/></form>';
		} else { print "<br>Comment Banning cannot be performed"; }
		$result = @mysql_query("SELECT * FROM main_comments",$link );
