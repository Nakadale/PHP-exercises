...
<div id="container">
	...
	<div id="body" style="position: absolute;top:257px;left:10px;width:980px;border:0px solid;">
		...
		echo '<td style="width:650px;">'.$row['post_date'].', '.$row['post_title'].'</td>';
		echo '<td style="text-align:right;width:100px;"><a href="postmod.php?ID='.$row['post_id'].'">Modify Post</a></td></table>';
		echo '</td></tr>';
