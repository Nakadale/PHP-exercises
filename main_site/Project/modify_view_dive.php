...
<div id="container">
	...
	<?php
		...
		echo ' <input type="submit" name="submit" value="Search" ></fieldset></form><br />';
		echo '<table style="width:800px;">';
		echo '<tr>';
			echo '<td align="center">Modify Dive Event</td>';
		echo '</tr>';
		echo '</table>';
		...
		echo '<tr id="com_body"><form action="moddiveview.php" method="POST">';
