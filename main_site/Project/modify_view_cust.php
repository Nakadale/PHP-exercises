...
<div id="container">
	...
	<!--end of navigation area of webpage-->
	</td><td valign="top" style="width:557px;text-align:left;overflow: auto;margin: 0px 16px 8px 0px;float:left;">
		...
		echo '<br /><table style="width:100%;">';
		 echo '<tr>';
			echo '<td align="center">Modify Customer Reservation List</td>';
		 echo '</tr>';
		echo '</table>';
		echo '<table border="1" style="width:1000px;">';
		 echo '<tr id="com_head">';
			...
			echo '<td style="width:50px;">Modify </td>';
		echo '<p></tr>';
		searchresult();
		...
		echo '<tr id="com_body"><form action="modcustview.php" method="POST">';
			...
			echo '<td><input type="hidden" name="hideval" value="'.$row['customer_number'].'">';
			echo '<input type="submit" name="edit" value="Modify"></td>';	
		echo '<p></form></tr>';
		}}
		echo '</table>';
		?>
