...
<div id="container">
	...
	<br />
		...
		$query = mysql_query("select * from comments",$link );
		If ($query == TRUE) {
		} else { print "Deletion cannot be performed"; }
		$query = mysql_query("DELETE FROM comments WHERE comment_number='".$delnum."'",$link);
		If ($query == TRUE) {
		echo '<div align="center" style="width:571px;">Comment Removed!<br>';
