...
<div id="container">
	...
	<!--end of navigation area of webpage-->
		...
		echo '<form method="post" action="view_customer_list.php">';
		echo '<input type="hidden" name="customer_number" value='.$custnum.'>';
		echo '<fieldset><legend><font style="color:white;">Customer Registration Information</font></legend>';
		...
		echo '<div align="center"><input type="submit" name="submit" value="Back" /></div><br>';
		echo '</fieldset></form>';
		?>
	</td>
